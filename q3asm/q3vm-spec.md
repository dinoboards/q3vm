...
| ADDRGP4 v   | ADDRESS OF GLOBAL (pointer). Takes v as a memory address, takes the 32-bit value at the address, pushes the 32-bit value to stack (i.e. get value of a global variable\|function/symbol).                                                                          |
