...
static const yytype_uint8 yyrline[] = { 0,  22, 22, 23, 26, 27, 30,
                                        31, 35, 36, 39, 40, 43, 44,
                                        45, 46, 49, 52, 53, 54, 57 };
#endif
...
static const char* const yytname[] = {
    "$end",  "error",    "$undefined", "TERMINAL", "START",   "PPERCENT",
    "ID",    "TEMPLATE", "CODE",       "INT",      "'\\n'",   "'='",
    "':'",   "'('",      "')'",        "','",      "$accept", "spec",
    "decls", "decl",     "blist",      "rules",    "nonterm", "tree",
    "cost",  YY_NULLPTR
};
#endif
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
static const yytype_int8 yypact[] = { -26, 11,  0,   -26, 5,   -26, 8,   -26,
                                      -26, -26, -26, 3,   -26, 7,   6,   9,
                                      -26, -26, 12,  -26, 13,  14,  -26, 15,
                                      -26, 16,  17,  15,  18,  4,   -26, 20,
                                      -26, 15,  -26, 19,  -26 };

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = { 4,  0, 0,  1, 0,  10, 0, 12, 8, 5,
...
static const yytype_int8 yytable[] = { -3, 4,  29, 5,  6,  7,  -2, 18, 35,
                                       15, 8,  3,  12, 16, 12, 10, 19, 17,
                                       32, 33, 21, 25, 22, 24, 28, 23, 30,
                                       0,  0,  27, 34, 0,  0,  36, 0,  20 };

static const yytype_int8 yycheck[] = { 0,  1,  27, 3,  4,  5,  0,  1,  33,
                                       6,  10, 0,  6,  10, 6,  10, 10, 10,
                                       14, 15, 11, 6,  10, 9,  7,  12, 8,
                                       -1, -1, 13, 10, -1, -1, 14, -1, 14 };

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = { 0,  17, 18, 0,  1,  3,  4,  5,  10, 19,
                                       10, 20, 6,  22, 21, 6,  10, 10, 1,  10,
                                       22, 11, 10, 12, 9,  6,  23, 13, 7,  23,
                                       8,  24, 14, 15, 10, 23, 14 };

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = { 0,  16, 17, 17, 18, 18, 19, 19, 19, 19, 20,
                                     20, 21, 21, 21, 21, 22, 23, 23, 23, 24 };

/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = { 0, 2, 3, 1, 0, 2, 3, 3, 1, 2, 0,
                                     4, 0, 7, 2, 3, 1, 1, 4, 6, 1 };
