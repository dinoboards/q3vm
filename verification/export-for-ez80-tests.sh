...
dataLengthL=$(xxd -s 13 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
dataLengthM=$(xxd -s 14 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
dataLengthH=$(xxd -s 15 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
dataLength="${dataLengthH}${dataLengthM}${dataLengthL}"

bssLengthL=$(xxd -s 16 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
bssLengthM=$(xxd -s 17 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
bssLengthH=$(xxd -s 18 -g 1 -e -l 1 -R never ./${QVM_BYTECODE} | cut -d' ' -f2)
